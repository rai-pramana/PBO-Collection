...
public class SetSmartphone {
    ...
    public static void main(String[] args) {
        ...
        // membuat dan menggunakan HashSet smartphones
        Set<String> smartphones = new HashSet<>();

        // menambahkan objek ke Set menggunakan method add()
        ...
        // mengeluarkan objek dari Set menggunakan method remove()
        smartphones.remove("Acer Aspire");

        System.out.println("Set smartphone :");

        // mencetak seluruh Set smartphones
